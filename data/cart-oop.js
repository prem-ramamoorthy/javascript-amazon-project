function Cart(localStorageKey) {
    const cart = {
        ...
        loadcart() {  
            this.cartList = JSON.parse(localStorage.getItem(localStorageKey)) || [
                    {
        ...
        savetostorage(){
            localStorage.setItem(localStorageKey , JSON.stringify(this.cartList)) ;
        },
...
if (!localStorage.getItem('cart-oop')) {
